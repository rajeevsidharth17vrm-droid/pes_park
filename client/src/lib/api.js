...
export const teamsApi = {
  ...
  logo:             (id)   => api.get(`/teams/${id}/logo`).then(r => r.data),
    playoffsCurrent:  ()     => api.get("/teams/playoffs/current").then(r => r.data),
  playoffsGenerate: ()     => api.post("/teams/playoffs/generate").then(r => r.data),
  playoffsReset:    ()     => api.post("/teams/playoffs/reset").then(r => r.data),
  playoffsResult:   (id, body) => api.patch(`/teams/playoffs/${id}/result`, body).then(r => r.data),
  playoffRecords:   (playoffMatchId) => api.get(`/records/playoff/${playoffMatchId}`).then(r => r.data),
  playoffRecordLog: (body)           => api.post("/records/playoff", body).then(r => r.data),
...
export const playersApi = {
  ...
  image:           (id)     => api.get(`/players/${id}/image`).then(r => r.data),
